...
<body>
 ...
 <!-- login  -->
 <div
 class="container d-flex flex-column flex-lg-row justify-content-evenly mt-5 pt-5 align-items-center"
>
 <!-- form  -->
 
 <div style="max-width: 28rem; width:10%; position: absolute;top:50%;left:50%">
   <div class="bg-white shadow rounded p-3 input-group-lg">
     <h1 class="text-centerzz; ">Log In</h1>
           ...
           <div class="modal-header">
             <div class="">
               ...
               <span class="text-muted fs-7"
                 >Join with us to discover something</span
               >
             </div>
             <button
               type="button"
